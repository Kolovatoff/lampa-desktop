...
- [Экспорт/импорт конфигурации](docs/export-import.md#экспорт-и-импорт-для-резервного-копирования)
- [Перенос конфигурации с другого приложения в это](docs/export-import.md#перенос-настроек)
